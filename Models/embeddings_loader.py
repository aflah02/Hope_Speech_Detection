...
def load_sent_trans_better_no_pca():
    ...
    x = np.load(os.path.join(save_path, 'english_sentence_model1_prePCA.npy'), allow_pickle=True)
    train, dev, test = x[0]
    return train, dev, test
...
def load_sent_trans_better_pca():
    parent_dir = os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir)))
    save_path = os.path.join(parent_dir, 'Word_Embeddings\Pre Computed Word Embeddings')
    x = np.load(os.path.join(save_path, 'english_sentence_model1_postPCA.npy'), allow_pickle=True)
    train, dev, test = x[0]
    return train, dev, test
...
def load_sent_trans_fast_no_pca():
    parent_dir = os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir)))
    save_path = os.path.join(parent_dir, 'Word_Embeddings\Pre Computed Word Embeddings')
    x = np.load(os.path.join(save_path, 'english_sentence_model2_prePCA.npy'), allow_pickle=True)
    train, dev, test = x[0]
    return train, dev, test
...
def load_sent_trans_fast_pca():
    parent_dir = os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir)))
    save_path = os.path.join(parent_dir, 'Word_Embeddings\Pre Computed Word Embeddings')
    x = np.load(os.path.join(save_path, 'english_sentence_model2_postPCA.npy'), allow_pickle=True)
    train, dev, test = x[0]
    return train, dev, test
